...
class payrollreportexcelwiz(models.TransientModel):
    ...
    def get_item_data(self):
        ...
        if self.from_date and self.date_end:
            ...
            worksheet.write(row, 4, 'Date début', cell_text_format_n)
            ...
            worksheet.write(row, 1, 'Indentifiant', cell_text_format)
            ...
            if payslip_ids:
                ...
                for payslip in payslip_ids:
                    ...
                    id = payslip.employee_id.contract_id.struct_id.code

                    worksheet.write(ro, col, name or '', cell_text_format_new)
                    worksheet.write(ro, col + 1, id or '',
